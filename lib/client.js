      ...
      function AutoDetectView(props) {
        ...
        return React.createElement(
          ...
          selection && createPortal(
            React.createElement("button", { ref: selectionButtonRef, type: "button", style: { ...selectionButtonStyle, left: selection.left, top: selection.top }, onMouseDown: (event) => {
              event.preventDefault();
            }, onClick: addSelection }, "\u6DFB\u52A0\u5230\u5BF9\u8BDD"),
            document.body
          ),
          React.createElement(
            "div",
